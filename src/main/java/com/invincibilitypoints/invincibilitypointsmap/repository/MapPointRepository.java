...
public interface MapPointRepository extends JpaRepository<MapPoint, Long> {
    ...
    boolean existsMapPointByCoordinatesAndIsDeleted(Point coordinates, Boolean isDeleted);
    ...
    @Query(value = "SELECT mp.*, " +
            ...
            "HAVING dislike_count < 20 AND is_deleted=false",
            nativeQuery = true)
    ...
    List<MapPoint> findMapPointByUserOwnerAndIsDeleted(User user, Boolean isDeleted);
}