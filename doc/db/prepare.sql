...
VALUES (ST_GeomFromText('POINT(50.50676522623323 30.603615370001677)'), 'Пункт toDelete', '08.00-20.00', 'Кафе',
        '5555-0000', 1),
...
VALUES
    (POINT(50.50676522623323 + (RAND() * 0.06 - 0.1), 30.603615370001677 + (RAND() * 0.06 - 0.1)), 'Ліки по знижці', '09.00-19.00', false, 'Аптека копійка', '1234567890', 1),
    (POINT(50.50676522623323 + (RAND() * 0.06 - 0.1), 30.603615370001677 + (RAND() * 0.06 - 0.1)), 'Є їжа та продовольчі продукти', '05.00-16.00', false, 'Магазин', '4534434534', 2),
    (POINT(50.50676522623323 + (RAND() * 0.06 - 0.1), 30.603615370001677 + (RAND() * 0.06 - 0.1)), 'Пропонуємо продуктові набори', '07.00-18.00', false, 'Сільпо', '45664642', 3),
    (POINT(50.50676522623323 + (RAND() * 0.06 - 0.1), 30.603615370001677 + (RAND() * 0.06 - 0.1)), 'Пропонуємо безкоштовні ліки', '07.00-13.00', false, 'Медсервіс', '2325143533', 4),
    (POINT(50.50676522623323 + (RAND() * 0.06 - 0.1), 30.603615370001677 + (RAND() * 0.06 - 0.1)), 'В наявності безкоштовні обіди та інтернет', '09.00-19.00', false, 'Міська їдальня', '1234423374', 5),
    (POINT(50.50676522623323 + (RAND() * 0.06 - 0.1), 30.603615370001677 + (RAND() * 0.06 - 0.1)), 'Є їжа та продовольчі продукти', '10.00-13.00', false, 'Магазин', '323343414', 6),
    (POINT(50.50676522623323 + (RAND() * 0.06 - 0.1), 30.603615370001677 + (RAND() * 0.06 - 0.1)), 'Працюємо від генераторів', '13.00-19.00', false, 'Кафе Їжачок', '334134432', 7),
    (POINT(50.50676522623323 + (RAND() * 0.06 - 0.1), 30.603615370001677 + (RAND() * 0.06 - 0.1)), 'Гарний настрій гарантовано', '12.00-16.00', false, 'Ворк-плейс', '090323123', 8),
    (POINT(50.50676522623323 + (RAND() * 0.06 - 0.1), 30.603615370001677 + (RAND() * 0.06 - 0.1)), 'В наявності б/у одяг', '12.00-19.00', false, 'Магазин Сток', '222-333', 9),
    (POINT(50.50676522623323 + (RAND() * 0.06 - 0.1), 30.603615370001677 + (RAND() * 0.06 - 0.1)), 'Є їжа та продовольчі продукти', '11.00-18.00', false, 'Їдальня', '4353531', 10),
    (POINT(50.50676522623323 + (RAND() * 0.06 - 0.1), 30.603615370001677 + (RAND() * 0.06 - 0.1)), 'Надаємо безкоштовний інтернет', '11.00-19.00', false, 'Коворкінг Free community', '099432354', 12),
    (POINT(50.50676522623323 + (RAND() * 0.06 - 0.1), 30.603615370001677 + (RAND() * 0.06 - 0.1)), 'Надаємо інтернет по знижці', '09.00-16.00', false, 'Кафе для роботи', '5453454353', 13),
    (POINT(50.50676522623323 + (RAND() * 0.06 - 0.1), 30.603615370001677 + (RAND() * 0.06 - 0.1)), 'Тепло та затишок гарантовані', '11.00-21.00', false, 'Соціальна їдальня', '43546564', 14),
    (POINT(50.50676522623323 + (RAND() * 0.06 - 0.1), 30.603615370001677 + (RAND() * 0.06 - 0.1)), 'Приємні ціни та швидке обслуговування', '10.00-21.00', false, 'Їдальня New life', '654534432', 15),
    (POINT(50.50676522623323 + (RAND() * 0.06 - 0.1), 30.603615370001677 + (RAND() * 0.06 - 0.1)), 'Маємо 5 генераторів', '06.00-22.00', false, 'Ворк-плейс', '436562434', 16),
    (POINT(50.50676522623323 + (RAND() * 0.06 - 0.1), 30.603615370001677 + (RAND() * 0.06 - 0.1)), 'Безкоштовний інтернет та електроенергія', '10.00-21.00', false, 'Ворк-плейс', '345545634', 17);
